        ...
        <div class="bg-gradient-to-r from-blue-900 to-green-600 h-1/2">
            <div class="flex items-center justify-between mx-4 py-5">
                <div class="flex flex-col gap-4">
                    <h1 class="text-2xl font-medium text-white">FISI - UNAP</h1>
                    <h1 class="text-5xl font-medium text-white uppercase">Generador de horario</h1>
                ...
                <div class="hidden md:flex justify-center items-center gap-4">
                    <img src="/logo_fisi.png" alt="" class="h-48">
                    <img src="/unap.png" alt="" class="h-48">
                </div>
            </div>
        </div>
        <div class="mx-4 py-5">
